...
![ZenML Architectural Overview](<.gitbook/assets/architecture (2).png>)
...
The initialization creates a local `.zen` folder where various information about your local configuration lives, e.g., the active [Stack](https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/guides/deploy\_to\_production.md) that you are using to run pipelines.
...
While this is just a function with a decorator, it is not super useful. ZenML steps really get powerful when you put them together with [data artifacts](https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/broken-reference/README.md). Read about more of that here!
...
Artifacts can be serialized and deserialized (i.e. written and read from the Artifact Store) in different ways like `TFRecord`s or saved model pickles, depending on what the step produces.The serialization and deserialization logic of artifacts is defined by [https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/reference/zenml/materializers.md](https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/reference/zenml/materializers.md "mention").
