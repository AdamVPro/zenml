...
![Quickstart steps](.gitbook/assets/quickstart-diagram.png)
...
* If your work involves a use-case that is fairly 'standard' training/inference/deployment, start with the [Class-based API](https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/guides/class-based-api/README.md) guide.
* If you have a more complex workflow that requires more control over your pipelines, start with the [Functional API](https://github.com/zenml-io/zenml/blob/main/docs/book/introduction/guides/functional-api/README.md) guide.
